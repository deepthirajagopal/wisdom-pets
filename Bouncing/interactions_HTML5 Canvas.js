...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({scaleY:0.7143,y:470.3},3,cjs.Ease.quadIn).to({regY:0.1,scaleX:0.8,scaleY:1.1428,y:410},7,cjs.Ease.cubicIn).wait(7).to({regY:0,scaleX:1,scaleY:0.7143,y:470.3},0).wait(3).to({scaleY:1,y:465},0).wait(3));
...
// library properties:
lib.properties = {
	id: 'EE28E0352D664BDD9CBDF2E9AE6B3CC5',
	width: 800,
	height: 600,
	fps: 24,
	color: "#CCFFFF",
...
an.compositions['EE28E0352D664BDD9CBDF2E9AE6B3CC5'] = {
